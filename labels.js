...
const GEO_LABELS = [
  ...
  { text: 'Guinea',          lat:   6,    lon: -10,    size: LABEL_SZ.REGION,                  minZoom: ZOOM.REGION_MIN, maxZoom: 6  },
  { text: 'Senegambia',      lat:  13.5,  lon: -14,    size: LABEL_SZ.REGION,                  minZoom: ZOOM.REGION_MIN, maxZoom: 7  },
  { text: 'Angola',          lat:  -9,    lon:  16,    size: LABEL_SZ.REGION,                  minZoom: ZOOM.REGION_MIN, maxZoom: 7  },
  ...
  { text: 'Saint-Domingue',  lat:  19,    lon: -72.5,  size: LABEL_SZ.ISLAND,                  minZoom: ZOOM.ISLAND_MIN, maxZoom: 5  },
  ...
  { text: 'Martinique',      lat:  14.6,  lon: -61,    size: LABEL_SZ.ISLAND,                  minZoom: ZOOM.ISLAND_MIN, maxZoom: 5  },
  { text: 'Guadeloupe',      lat:  16.3,  lon: -61.5,  size: LABEL_SZ.ISLAND,                  minZoom: ZOOM.ISLAND_MIN, maxZoom: 5  },
  { text: 'Cayenne',         lat:   4.9,  lon: -52.3,  size: LABEL_SZ.ISLAND,                  minZoom: ZOOM.ISLAND_MIN, maxZoom: ZOOM.MAX },
  { text: 'Bourbon Island',  lat: -21,    lon:  55.5,  size: LABEL_SZ.ISLAND,                  minZoom: ZOOM.ISLAND_MIN, maxZoom: 5  },
  { text: 'Isle of France',  lat: -20.3,  lon:  57.5,  size: LABEL_SZ.ISLAND,                  minZoom: ZOOM.ISLAND_MIN, maxZoom: 5  },
